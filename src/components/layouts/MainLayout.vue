...
<template>
  <div class="main-layout-bg min-h-screen">
    ...
    <button
      ...
      class="fixed bottom-[5.5rem] right-4 lg:bottom-6 lg:right-6 z-40 inline-flex items-center gap-2 px-3.5 py-2 rounded-xl bg-white dark:bg-gray-800 border border-gray-200/90 dark:border-gray-700 text-gray-600 dark:text-gray-400 text-[13px] font-medium shadow-sm shadow-gray-900/8 hover:bg-gray-50 dark:hover:bg-gray-700/80 hover:text-gray-900 dark:hover:text-gray-100 hover:border-gray-300 dark:hover:border-gray-600 transition-all duration-200 active:scale-[0.97]"
    >
