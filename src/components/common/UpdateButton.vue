...
function apply(payload) {
  ...
  switch (payload.status) {
    ...
    case 'downloading':
      ...
      break
    case 'downloaded':
      // One-click intent: finish by relaunching into the new version.
...
onMounted(async () => {
  ...
  // Catch any state that landed before we subscribed, then kick off a check.
...
<template>
  <div v-if="show">
    ...
    <!-- Downloaded — installing/relaunching -->
    <div
